...
Верификация: заголовки отсутствуют — приложение уязвимо к clickjacking и XSS. Подтверждено.
...
Верификация: заголовок Server раскрывает версии Werkzeug/Python.Подтверждено
